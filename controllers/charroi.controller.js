...
exports.getValidationInspection = (req, res) => {
    ...
    const query = `
                    SELECT iv.id_sub_inspection_gen, iv.id_type_reparation, iv.manoeuvre, iv.cout, ig.id_vehicule, iv.budget_valide, sub.avis, sub.commentaire as description FROM inspection_valide iv
...
exports.getTrackingGen = (req, res) => {
    ...
    db.query(qDetails, [likeSearch, likeSearch, likeSearch, likeSearch], (error, details) => {
      if (error) return res.status(500).send(error);
  
      db.query(qCount, [likeSearch, likeSearch, likeSearch, likeSearch], (err, counts) => {
