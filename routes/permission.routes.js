...
const { menusAllTrue, menusAll, permissions, putPermission, menusAllOne, getPermissionTache, postPermissionTache, getPermissionVille, getPermissionVilleOne, postPermissionVille, getPermissionDepartementOne, postPermissionDepartement, getPermissionDeclarationVilleOne, postPermissionDeclarationVille, getPermissionDeclaration, postPermissionDeclaration, getPermissionDeclarationClientOne, postPermissionDeclarationClient, getPermissionProjet, postPermissionProjet, postPermissionUserVehicule} = require("../controllers/permission.controller");
const verifyToken = require("../midllewares/verifyToken");
const router = express.Router();

router.get('/addOne', menusAllOne)
router.get('/add_admin', menusAllTrue)
...
//Permission user vehicule
router.post('/user_vehicule_permission', postPermissionUserVehicule)
